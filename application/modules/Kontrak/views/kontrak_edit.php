					...
					<div class="card">
						...
						<div class="card-body row">
							...
							<div class="row mb-3">
								...
								<div class="col-lg-9">
									<input type="text" class="form-control <?= form_error('pegawai') ? 'is-invalid' : ''; ?>" id="pegawai" name="pegawai" value="<?= $kontrak->nama; ?>" readonly disabled>
								</div>
							</div>
							<div class="row mb-3">
								<div class="col-lg-3">
								...
								<div class="col-lg-9">
									<select class="form-select <?= form_error('jabatan') ? 'is-invalid' : ''; ?>" name="jabatan" id="jabatan" readonly>
										<option value="">--Pilih--</option>
										<?php foreach ($jabatan as $key => $dt) : ?>
											<option value="<?= $dt->id_jabatan; ?>" <?= $kontrak->id_jabatan == $dt->id_jabatan ? 'selected' : ''; ?>><?= $dt->nama_jabatan; ?></option>
										<?php endforeach ?>
									</select>
								</div>
							</div>
							...
							<div class="row mb-3">
								...
								<div class="col-lg-9">
									<input type="date" class="form-control <?= form_error('tgl_kontrak') ? 'is-invalid' : ''; ?>" data-provider="flatpickr" id="tgl_kontrak" name="tgl_kontrak" value="<?= $kontrak->tgl_kontrak; ?>">
								</div>
							</div>
							<div class="row mb-3">
								<div class="col-lg-3">
								...
								<div class="col-lg-9">
									<input type="date" class="form-control <?= form_error('tgl_mulai') ? 'is-invalid' : ''; ?>" data-provider="flatpickr" id="tgl_mulai" name="tgl_mulai" value="<?= $kontrak->tgl_mulai; ?>" placeholder="Pilih Tanggal Mulai">
								</div>
							</div>
							<div class="row mb-3">
								<div class="col-lg-3">
								...
								<div class="col-lg-9">
									<input type="date" class="form-control <?= form_error('tgl_akhir') ? 'is-invalid' : ''; ?>" data-provider="flatpickr" id="tgl_akhir" name="tgl_akhir" value="<?= $kontrak->tgl_akhir; ?>" placeholder="Pilih Tanggal Akhir">
								</div>
							</div>
						</div>
