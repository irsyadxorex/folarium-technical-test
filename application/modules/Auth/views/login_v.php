				...
				<div class="row">
					<div class="col-lg-12">
						<div class="text-center mt-sm-5 mb-4 text-white-50">
							<p class="mt-3 fs-15 fw-medium text-dark">Login</p>
						</div>
					</div>
				</div>
				<!-- end row -->
								...
								<div class="p-2 mt-4">
									<form action="" method="POST">
										<div class="mb-3">
											...
											<input type="email" class="form-control <?= form_error('email') ? 'is-invalid' : ''; ?>" id="email" placeholder="Enter email" name="email">
										...
										<div class="mb-3">
											...
											<div class="position-relative auth-pass-inputgroup mb-3">
												<input type="password" class="form-control pe-5 password-input <?= form_error('password') ? 'is-invalid' : ''; ?>" placeholder=" Enter password" id="password-input" name="password">
					...
					<div class="col-lg-12">
						<div class="text-center">
							<p class="mb-0 text-muted">&copy;
								...
								</script> Irsyad. Crafted with <i class="mdi mdi-heart text-danger"></i>
							</p>
						</div>
					</div>
				</div>
